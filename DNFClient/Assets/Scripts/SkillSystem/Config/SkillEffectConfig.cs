...
public class SkillEffectConfig
{
    ...
    [LabelText("特效偏移位置")] public Vector3 effectOffsetPos; //特效偏移位置
    [LabelText("特效位置类型")] public EffectPosType effectPosType; //特效位置类型
    ...
    [HideInInspector] public GameObject GameEffectObj; //游戏特效缓存对象
#if UNITY_EDITOR
    //Editor模式下克隆的特效对象
