...
Shader "MS/effect_alpha/gradientMap"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 MainTex_RGB52 = (tex2DNode44).rgb;
				float3 VertexColor_RGB67 = (i.ase_color).rgb;
				float3 hsvTorgb133 = RGBToHSV( ( MainTex_RGB52 * VertexColor_RGB67 ) );
				float2 appendResult134 = (float2(hsvTorgb133.z , hsvTorgb133.z));
				...
				float4 appendResult39 = (float4(( (1.0 + (_HDR - 0.0) * (16.0 - 1.0) / (1.0 - 0.0)) * (tex2D( _GradientTex, appendResult134 )).rgb ) , Alpha105));
...
/*ASEBEGIN
Version=18707
-23;25;1627;800;-21.42078;1481.059;1.472498;True;True
Node;AmplifyShaderEditor.CommentaryNode;51;-2092.192,-1675.32;Inherit;False;2184.617;540.2427;MainTex;10;130;129;128;127;126;125;44;37;53;52;主图;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector2Node;129;-1368.25,-1480.963;Inherit;False;Property;_MainSpeed;MainSpeed;5;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.GetLocalVarNode;69;656.6021,-660.0592;Inherit;False;67;VertexColor_RGB;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;56;681.3122,-869.4734;Inherit;False;52;MainTex_RGB;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;994.293,-839.8151;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RGBToHSVNode;133;1184.85,-818.5412;Inherit;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.DynamicAppendNode;134;1407.622,-843.2382;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;138;1559.387,-988.9252;Inherit;False;Property;_HDR;HDR;4;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;136;1866.182,-830.7932;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TFHCRemapNode;139;1913.378,-1038.029;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;1;False;4;FLOAT;16;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;106;1586.538,-598.0629;Inherit;False;105;Alpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;137;2104.196,-839.3898;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.DynamicAppendNode;39;2241.854,-773.4899;Inherit;False;FLOAT4;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
WireConnection;39;0;137;0
WireConnection;39;3;106;0
WireConnection;1;0;39;0
ASEEND*/
//CHKSM=308BC9E2646EEB422E4FE942B54ACB1EE12313E9