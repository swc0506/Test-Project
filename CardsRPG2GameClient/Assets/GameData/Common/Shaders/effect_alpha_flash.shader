...
Shader "MS/effect_alpha_flash"
{
	Properties
	{
		...
		_Alpha("Alpha", Range( 0 , 1)) = 0.55726
		_AlphaWdith("AlphaWdith", Range( 0 , 1)) = 0.3979152
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float MainTex_A53 = tex2DNode44.a;
				float VertexColor_A68 = i.ase_color.a;
				float clampResult143 = clamp( _Color.a , 0.0 , 1.0 );
				float color_A140 = clampResult143;
				float temp_output_172_0 = ( _Alpha * VertexColor_A68 * color_A140 );
				float temp_output_165_0 = (0.0 + (temp_output_172_0 - 0.0) * (( _AlphaWdith + temp_output_172_0 ) - 0.0) / (1.0 - 0.0));
				float clampResult161 = clamp( ( temp_output_165_0 - _AlphaWdith ) , 0.0 , 1.0 );
				...
				float smoothstepResult147 = smoothstep( clampResult161 , temp_output_165_0 , MaskTex_R64);
				float Alpha105 = ( MainTex_A53 * NoiseTex_R60 * ( (0.0 + (smoothstepResult147 - 0.0) * (1.0 - 0.0) / (0.5 - 0.0)) * (1.0 + (smoothstepResult147 - 0.5) * (0.0 - 1.0) / (1.0 - 0.5)) ) );
...
Node;AmplifyShaderEditor.Vector4Node;87;-1784.289,-225.662;Inherit;False;Property;_Mask_Tiling_Offset;Mask_Tiling_Offset;11;0;Create;True;0;0;False;0;False;1,1,0,0;1,1.5,0,-0.25;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;140;-402.2003,-1249.216;Inherit;False;color_A;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;172;478.2966,231.2951;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;41;-1803.572,-902.0594;Inherit;False;Property;_Noise_Tiling_Offset;Noise_Tiling_Offset;8;0;Create;True;0;0;False;0;False;1,1,0,0;5,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;166;574.8102,86.4227;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;165;765.0277,168.091;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;3;-422.3576,-287.0271;Inherit;True;Property;_MaskTex;MaskTex;9;0;Create;True;0;0;False;0;False;-1;d8af310c2fbd8fa4895315f6142f12e2;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;153;966.7883,1.439037;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;64;-119.2208,-258.7359;Inherit;False;MaskTex_R;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;17;-1098.353,-849.4719;Inherit;False;Property;_NoiseSpeed;NoiseSpeed;7;0;Create;True;0;0;False;0;False;0,0;3,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ClampOpNode;161;1128.471,-75.34595;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;65;231.9974,-137.0138;Inherit;False;64;MaskTex_R;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SmoothstepOpNode;147;1330.227,-123.8834;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;19;-441.6011,-872.8447;Inherit;True;Property;_NoiseTex;NoiseTex;6;0;Create;True;0;0;False;0;False;-1;None;b40767c8eb9d23846b0e1296a41526c7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TFHCRemapNode;169;1594.572,-166.9975;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0.5;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;170;1579.234,27.9817;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;1;False;3;FLOAT;1;False;4;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;62;231.9431,-230.7661;Inherit;False;60;NoiseTex_R;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;171;1811.216,-140.2426;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;57;232.2766,-317.0128;Inherit;False;53;MainTex_A;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;133;2120.306,-303.8347;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;105;2383.757,-307.8983;Inherit;False;Alpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;172;0;35;0
WireConnection;172;1;70;0
WireConnection;172;2;141;0
WireConnection;93;0;90;0
WireConnection;93;2;91;0
WireConnection;166;0;135;0
WireConnection;166;1;172;0
...
ASEEND*/
//CHKSM=953CC43A72652C53A5E1981419B25BC8705C0BF3