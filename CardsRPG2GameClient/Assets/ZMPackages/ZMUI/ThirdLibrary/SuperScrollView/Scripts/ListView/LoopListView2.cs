...
namespace SuperScrollView
{
    ...
    public class LoopListViewInitParam
    {
        ...
        public float mSmoothDumpRate = 0.3f;//滚动速率0-1 速率越小，滚动切换越快
        public float mSnapFinishThreshold = 0.01f;//自适应吸附完成的阈值，完成后会触发SnapFinish回调，值越大吸附完成越早，越小越平滑
        public float mSnapVecThreshold = 145; //自适应吸附的阈值，当ScrollView.velocity速度小于这个值是会自动吸附适应。常作用于分页滚动
        /// <summary>
