...
Shader "YXZ/Effect/cgwell/Dissolution_Blend" {
    Properties {
...
////// Emissive:
                ...
                float node_5746_if_leA = step(node_1423,_T_mask_var.a);
                float node_5746_if_leB = step(_T_mask_var.a,node_1423);
//                float node_3073 = 0.0;
//                float node_6272 = 1.0;
                ...
                float node_1274 = (node_5746-lerp((node_5217_if_leB),1,node_5217_if_leA*node_5217_if_leB));
                float3 finalColor = emissive + ((node_1274*_C_BYcolor.rgb)*_N_BY_QD);
                CA_SOFTPARTICLES_FADE(i, _MainTex_var.a);
