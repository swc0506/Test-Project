...
{
	public class PassWindow : WindowBase
	{
		public PassWindowUIComponent uiComp = new PassWindowUIComponent();
		...
		public void OnChangeToggleChange(bool state,Toggle toggle)
		{
		}
