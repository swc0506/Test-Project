...
namespace U3DExtends
{
    ...
    {
        //是否开启场景中的右键菜单
        public static bool IsShowSceneMenu = false;
        ...
        //是否开启用箭头按键移动UI节点
        public static bool IsMoveNodeByArrowKey = false;

        //保存界面时是否需要显示保存成功的提示框
        public static bool IsShowDialogWhenSaveLayout = false;

        //结束游戏运行时是否重新加载运行期间修改过的界面
        public static bool ReloadLayoutOnExitGame = false;
