...
namespace My.Physics3D
{
    public partial class FixIntCollider3D
    {
        ...
        /// 逻辑坐标
        /// </summary>
        public FixIntVector3 LogicPos { get; protected set; }
        ...
        public Collider3DEnum Collider3DEnum { get; protected set; }
        ...
        /// 需要修正位置
        /// </summary>
        private FixIntVector3 mAdjustPos;

        public FixIntVector3 AdjustPos
        {
            get
            {
                CanAdjust = false;
        ...
        public virtual void OnRelease()
        {
            this.Active = false;
            ClearCollisionData();
            PhysicsWorld3D.Instance.RemoveCollider3D(this);
        } 
