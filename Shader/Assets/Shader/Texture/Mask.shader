Shader "Unlit/Mask"
{
    Properties
    {
        ...
        _SpecularMask("SpecularMask", 2D) = ""{}//高光反射遮罩
        _SpecularScale("SpecularScale", Float) = 1//高光反射遮罩系数
    ...
    SubShader
    {
        Pass
        {
            ...
            sampler2D _SpecularMask;//高光反射遮罩
            float4 _Specular_ST;//高光反射遮罩的缩放和平移
            float _SpecularScale;//高光反射遮罩系数
